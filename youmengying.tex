...
% 设置页面背景为淡黄色
\definecolor{lightyellow}{RGB}{249, 243, 230} % 更柔和的米黄色，类似宣纸
\AddToShipoutPictureBG{\color{lightyellow}\rule{\paperwidth}{\paperheight}}
...
\setCJKmainfont{Noto Serif CJK SC} % 思源宋体旧名
...
{%
    ...
    \setlength{\parindent}{0pt} % 首行缩进 1em ，和常见排版统一逻辑
    \fontsize{10}{12}\selectfont % 显式激活字体大小，原代码漏了 \selectfont
}{%
    \par\vspace{0.3cm} % 结束也加间距，让段落区分更清晰（可根据需求调整/删除）
}
